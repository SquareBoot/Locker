...
public class DisplayModeTest extends JFrame implements ActionListener,
    ...
    public static final int INDEX_BIT_DEPTH = 2;
    public static final int INDEX_REFRESH_RATE = 3;
    ...
    public void setDMLabel(DisplayMode newMode) {
        ...
        currentDM.setText(
                COLUMN_NAMES[INDEX_WIDTH] + ": " + newMode.getWidth() + " "
                        ...
                        + COLUMN_NAMES[INDEX_BIT_DEPTH] + ": " + bd + " "
                        + COLUMN_NAMES[INDEX_REFRESH_RATE] + ": " + rr
        );
    }
